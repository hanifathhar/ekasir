...
class supplier{
    ...
    function view($act){
			...
			echo "<div class=\"page-header\">
					...
					<div class=\"row\">
						<div class=\"col-md-12\">
							<div class=\"card\">
								<div class=\"card-header\">
									...
									<tr>
										<td>
											<a href=\"welcome.php?modul=supplier&aksi=input\">
										...
										<td>
											...
											<button class=\"btn btn-success btn-sm\">
												<i class=\"fas fa-upload\"></i> Import Data Supplier
											</button>
											</a>
										</td>
									</tr>
										...
										<table id=\"basic-datatables\" class=\"display table table-striped table-hover\" >
											<thead>
												  <tr>
													...
													<th class=\"text-center\" style=\"background-color:#000033; color:#FFFFFF\">Nama Supplier</th>
											...
											<tbody>";
											 ...
											 echo "<tr>
													...
													<div class=\"card-list\">
														<div class=\"item-list\">
														<form method=\"post\" action=\"welcome.php?modul=supplier&aksi=edit\">
															<button class=\"btn btn-icon btn-primary btn-round btn-xs\" type=\"submit\" value=\"$fetchArray[id_supplier]\" name=\"id\">
																<i class=\"fas flaticon-pen\"></i>
															</button>
															</form>
															&nbsp;
															<form method=\"post\" action=\"welcome.php?modul=supplier&aksi=hapus\">
															<button class=\"btn btn-icon btn-danger btn-round btn-xs\" type=\"submit\" value=\"$fetchArray[id_supplier]\" name=\"id\" 
						...
						<form enctype=\"multipart/form-data\" method=\"post\" action=\"controler/upload_supplier.php\">
						  <div class=\"modal-content\">
							<div class=\"modal-header\" style=\"background-color:#003399; color:#FFFFFF;\">
							  <h5 class=\"modal-title\" id=\"exampleModalLabelLogout\"><i class=\"fas fa-upload\"></i> Import Data Supplier</h5>
							</div>
							...
							echo "<div class=\"form-group\">
									...
									<b> <a title=\"Download File\" href=\"controler/download.php?file=template_supplier.xls\">
									      <i class=\"fa  fa-download\"></i> template_supplier.xls
									 </a></b>
									</div>
									<div class=\"modal-title\">
	...
	function hapus($id){
			...
			include("config/config.php");
    		$query = mysqli_query($conn,"delete from tbl_supplier where id_supplier='$id'");
			...
			if($query){
				echo "<script type=\"text/javascript\">
					...
					function() {
						window.location = \"welcome.php?modul=supplier&aksi=view\";
					}
					);
					</script>";
				}else{
