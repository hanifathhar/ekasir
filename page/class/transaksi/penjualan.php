							...
							<form action=\"\" method=\"post\">
								...
								<div class=\"card-header\">
									...
									<div class=\"form-group row\">
									  <label for=\"inputEmail3\" class=\"col-sm-1 col-form-label\" style=\"text-align:right\">Periode Penjualan</label>
									  <div class=\"col-sm-2\">
								...
								<div class=\"card-header\" align=\"right\">
									...
									<tr>
										<td>
											<form method=\"post\" action=\"welcome.php?modul=penjualan&aksi=report\" target=\"\">
										...
										<table id=\"basic-datatables\" class=\"display table table-striped table-hover\" >
											<thead>
												  <tr>
													...
													<th class=\"text-center\" style=\"background-color:#000033; color:#FFFFFF; font-size:12px;\" width=100>Pembeli</th>
													<th class=\"text-center\" style=\"background-color:#000033; color:#FFFFFF; font-size:12px;\" width=5>Metode<br>Pembayaran</th>
													<th class=\"text-center\" style=\"background-color:#000033; color:#FFFFFF; font-size:12px;\" width=>Total<br>Belanja</th>
													...
													<th class=\"text-center\" style=\"background-color:#000033; color:#FFFFFF; font-size:12px;\" width=>Total<br>Penjualan</th>
													<th class=\"text-center\" style=\"background-color:#000033; color:#FFFFFF; font-size:12px;\" width=>Pembayaran</th>
													<th class=\"text-center\" style=\"background-color:#000033; color:#FFFFFF; font-size:12px;\" width=>Saldo</th>													
											...
											<tbody>";
											 $baca = mysqli_query($conn,"SELECT  *,DATE_FORMAT(tgl_transaksi, '%d/%m/%Y') AS tgl,IF(pembayaran=1,'Tunai','Kredit') as bayar,
											         ...
											         FROM tbl_pembayaran WHERE tgl_transaksi BETWEEN '$tgl1' and '$tgl2' ORDER BY no_transaksi,tgl_transaksi");
											 $no = 1;	
											 ...
											 echo "<tr>
													...
													<div class=\"card-list\">
														<div class=\"item-list\">
														<form method=\"post\" action=\"welcome.php?modul=penjualan&aksi=invoice\">
														<input type=\"hidden\" name=\"tgl1\" value=\"$tgl1\">
														<input type=\"hidden\" name=\"tgl2\" value=\"$tgl2\">
														<button class=\"btn btn-icon btn-primary btn-round btn-xs\" type=\"submit\" value=\"$fetchArray[no_transaksi]\" name=\"id\" >
															...
															&nbsp;
															<form method=\"post\" action=\"welcome.php?modul=penjualan&aksi=hapus\">
															<input type=\"hidden\" name=\"tgl1\" value=\"$tgl1\">
														    <input type=\"hidden\" name=\"tgl2\" value=\"$tgl2\">
