...
class returpenjualan{
							...
							<form action=\"\" method=\"post\">
								...
								<div class=\"card-header\">
									...
									<div class=\"form-group row\">
									  <label for=\"inputEmail3\" class=\"col-sm-2 col-form-label\" style=\"text-align:right\">Periode Retur Penjualan</label>
									  <div class=\"col-sm-2\">
								...
								<div class=\"card-header\" align=\"right\">
									...
									<tr>
										<td>
											<a href=\"welcome.php?modul=returpenjualan&aksi=input\">
											<button class=\"btn btn-primary btn-sm\"><i class=\"fa flaticon-pen\"></i> Input Retur Penjualan</button>
											</a>
										</td>
										<td>
											<form method=\"post\" action=\"welcome.php?modul=returpenjualan&aksi=report\" target=\"\">
										...
										<table id=\"basic-datatables\" class=\"display table table-striped table-hover\" >
											<thead>
												  <tr>
													...
													<th class=\"text-center\" style=\"background-color:#000033; color:#FFFFFF; font-size:12px;\" width=100>Pelanggan</th>
											...
											<tbody>";
											 $baca = mysqli_query($conn,"SELECT  *,DATE_FORMAT(tgl_transaksi, '%d/%m/%Y') AS tgl,IF(pembayaran=1,'Tunai','Kredit') as bayar,
											         (select nm_pengguna from admin where id=tbl_retur_penjualan.user) as kasir,IF(nm_member<>'',nm_member,'Umum') as member 
											         FROM tbl_retur_penjualan WHERE tgl_transaksi BETWEEN '$tgl1' and '$tgl2' ORDER BY no_transaksi,tgl_transaksi");
											 $no = 1;	
											 ...
											 echo "<tr>
													...
													<div class=\"card-list\">
														<div class=\"item-list\">
															<div class=\"info-user ml-3\">
																<div class=\"status\"><b>".($fetchArray['member'])."</b></div>
													...
													<div class=\"card-list\">
														<div class=\"item-list\">
														   <form method=\"post\" action=\"welcome.php?modul=returpenjualan&aksi=invoice\">
															<input type=\"hidden\" name=\"tgl1\" value=\"$tgl1\">
															<input type=\"hidden\" name=\"tgl2\" value=\"$tgl2\">
															...
															if($res < 1 ){
															echo "<form method=\"post\" action=\"welcome.php?modul=returpenjualan&aksi=edit\">
															<input type=\"hidden\" name=\"tgl1\" value=\"$tgl1\">
															<input type=\"hidden\" name=\"tgl2\" value=\"$tgl2\">
															...
															echo"
															&nbsp;
															<form method=\"post\" action=\"welcome.php?modul=returpenjualan&aksi=hapus\">
															<input type=\"hidden\" name=\"tgl1\" value=\"$tgl1\">
														    <input type=\"hidden\" name=\"tgl2\" value=\"$tgl2\">
	...
	function hapus($id,$tgl1,$tgl2){
    		...
    		$query = mysqli_query($conn,"delete from tbl_retur_penjualan where no_transaksi='$id'");
			$query = mysqli_query($conn,"delete from tbl_retur_penjualan_det where no_transaksi='$id'");
