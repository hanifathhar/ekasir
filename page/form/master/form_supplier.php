...
$baca  = mysqli_query($conn,"SELECT  * from tbl_supplier where id_supplier='$id'");
                ...
                <div class="card-body">
				  ...
				  <div class="row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="inputEmail3" placeholder="" name="nama" value="<?php echo "$data[nm_supplier]";?>" required>
                      </div>
                    </div>
					<div class="form-group row">
					...
					<div class="card-action">
						 ...
						 <a href="welcome.php?modul=supplier&aksi=view"><button type="button" class="btn btn-danger"><i class="fas fa-reply"></i> Batal</button></a>
								</div>
                  </form>
                </div>
...
$aksi = $_POST['aksi'];
	...
	if($aksi == 'edit'){
				...
				$query = mysqli_query($conn,"UPDATE tbl_supplier SET nm_supplier = '$nama',
													   no_telp = '$no_telp',
													   email = '$email',
													   alamat = '$alamat',
													   kota = '$kota'
				...
				echo "<form action=\"welcome.php?modul=supplier&aksi=edit\" method=\"post\" id=\"success\">
				...
				$query = mysqli_query($conn,"INSERT INTO tbl_supplier (nm_supplier,no_telp,email,alamat,kota) 
									  VALUE('$nama','$no_telp','$email','$alamat','$kota')");
				...
				echo "<script type=\"text/javascript\">
					...
					function() {
						window.location = \"welcome.php?modul=supplier&aksi=view&act=1\";
					}
					);
					</script>";
				}else{
