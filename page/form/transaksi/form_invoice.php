...
$sql = mysqli_query($conn,"SELECT  *,DATE_FORMAT(tgl_transaksi, '%d/%m/%Y') AS tgl,IF(pembayaran=1,'Tunai','Kredit') as bayar,(select nm_pengguna from admin where id=tbl_pembayaran.user) as kasir,  
                           IF(nm_member<>'',nm_member,'Umum') as pembeli from tbl_pembayaran where no_transaksi='$id'");
		  ...
		  ?>
            ...
            <div class="card mb-12">
                <div class="card-header">
									<div class="card-title"><i>Faktur Penjualan</i></div>
								</div>
                <div class="card-body">
				  ...
				  echo "<div id=\"container\">
						...
						Nama Pelanggan : $data[pembeli]</br>
						Alamat : -
						</td>
						...
						<td align='center'>TTD,</br></br><u>($data[kasir])</u></td>
						</tr>
						</table>
						</center>
						</div>";
				...
				<div class="card-action" align="right">
					 ...
					 <a href="welcome.php?modul=kasir&aksi=input"><button type="button" class="btn btn-danger"><i class="fas fa-reply"></i> Kemabli</button></a>
				</div>
