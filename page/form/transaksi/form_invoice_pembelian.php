...
$sql = mysqli_query($conn,"SELECT  *,DATE_FORMAT(tgl_transaksi, '%d/%m/%Y') AS tgl,IF(pembayaran=1,'Tunai','Kredit') as bayar,(select nm_pengguna from admin where id=tbl_pembelian.user) as kasir,  
                           IF(nm_supplier<>'',nm_supplier,'Umum') as supplier from tbl_pembelian where no_transaksi='$id'");
		  ...
		  ?>
            ...
            <div class="card mb-12">
                <div class="card-header">
									<div class="card-title"><i><i class="fas fa-print"></i> Faktur Pembelian</i></div>
								</div>
                <div class="card-body">
				  ...
				  echo "<div id=\"container\">
						...
						$baca = mysqli_query($conn,"SELECT  * FROM tbl_pembelian_det where no_transaksi='$id' ORDER BY id");
						$no = 1;	
				...
				<div class="card-action" align="right">
					 ...
					 echo "<div class=\"table-responsive\">
									...
									<tr>
										...
										<td>
											<form method=\"post\" action=\"welcome.php?modul=pembelian&aksi=view\">
