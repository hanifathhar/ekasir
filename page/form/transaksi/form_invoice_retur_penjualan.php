...
$sql = mysqli_query($conn,"SELECT  *,DATE_FORMAT(tgl_transaksi, '%d/%m/%Y') AS tgl,IF(pembayaran=1,'Tunai','Kredit') as bayar,(select nm_pengguna from admin where id=tbl_retur_penjualan.user) as kasir,  
                           IF(nm_member<>'',nm_member,'Umum') as member from tbl_retur_penjualan where no_transaksi='$id'");
		  ...
		  ?>
            ...
            <div class="card mb-12">
                <div class="card-header">
									<div class="card-title"><i><i class="fas fa-print"></i> Retur Penjualan</i></div>
								</div>
                <div class="card-body">
				  ...
				  echo "<div id=\"container\">
						...
						<b><span style='font-size:12pt'>RETUR PENJUALAN</span></b></br>
						No Trans. : $id</br>
						Tanggal : $data[tgl]</br>
						</td>
						</table>
						...
						$baca = mysqli_query($conn,"SELECT  * FROM tbl_retur_penjualan_det where no_transaksi='$id' ORDER BY id");
						$no = 1;	
						...
						<td align='center'>TTD,</br></br><u>($data[member])</u></td>
						</tr>
						</table>
						</center>
						</div>";
