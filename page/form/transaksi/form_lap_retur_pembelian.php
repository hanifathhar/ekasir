...
?>
		  ...
		  <?php
			...
			echo "<div class=\"page-header\">
						<h4 class=\"page-title\">Laporan Retur Pembelian</h4>
						<ul class=\"breadcrumbs\">
							...
							<li class=\"nav-item\">
								<a href=\"#\">Laporan Retur Pembelian</a>
							</li>
						</ul>
					</div>";
		  ...
		  ?>
            ...
            <div class="card mb-12">
                <div class="card-header">
									<div class="card-title"><i><i class="fas fa-print"></i> Laporan Retur Pembelian</i></div>
								</div>
                <div class="card-body">
				<div class="table-responsive"> 
				 ...
				 echo "<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"> 
							 <tr>
								<td align=\"center\" style=\"font-size:16px;border:solid 0px black;\" colspan=5><h3><b>LAPORAN RETUR PEMBELIAN</b></h3>
								</td>
							</tr>
							<tr>
					 ...
					 echo "<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"0\" cellpadding=\"4\" >
											<thead>
												  <tr>
													...
													<th class=\"text-center\" style=\"font-size:12px;\" width=100>Supplier</th>
						...
						$baca = mysqli_query($conn,"SELECT  *,DATE_FORMAT(tgl_transaksi, '%d/%m/%Y') AS tgl,IF(pembayaran=1,'Tunai','Non Tunai') as bayar,
											         ...
											         FROM tbl_retur_pembelian WHERE tgl_transaksi BETWEEN '$tglx' and '$tgly' ORDER BY no_transaksi,tgl_transaksi");
						$no = 1;	
