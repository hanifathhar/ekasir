...
?>
		  ...
		  <?php
			...
			echo "<div class=\"page-header\">
						<h4 class=\"page-title\">Laporan Retur Penjualan</h4>
						<ul class=\"breadcrumbs\">
							...
							<li class=\"nav-item\">
								<a href=\"#\">Laporan Retur Penjualan</a>
							</li>
						</ul>
					</div>";
		  ...
		  ?>
            ...
            <div class="card mb-12">
                <div class="card-header">
									<div class="card-title"><i><i class="fas fa-print"></i> Laporan Retur Penjualan</i></div>
								</div>
                <div class="card-body">
				<div class="table-responsive"> 
				 ...
				 echo "<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"> 
							 <tr>
								<td align=\"center\" style=\"font-size:16px;border:solid 0px black;\" colspan=5><h3><b>LAPORAN RETUR PENJUALAN</b></h3>
								</td>
							</tr>
							<tr>
					 ...
					 echo "<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"0\" cellpadding=\"4\" >
											<thead>
												  <tr>
													...
													<th class=\"text-center\" style=\"font-size:12px;\" width=10>No. Retur</th>
													<th class=\"text-center\" style=\"font-size:12px;\" width=10>No. Faktur</th>
													<th class=\"text-center\" style=\"font-size:12px;\" width=100>Pelanggan</th>
													...
													<th class=\"text-center\" style=\"font-size:12px;\" width=50>Total<br>Pengembalian</th>
													<th class=\"text-center\" style=\"font-size:12px;\" width=50>Total<br>Pembayaran</th>
													<th class=\"text-center\" style=\"font-size:12px;\" width=50>Sisa</th>	
												  </tr>
											</thead>
											<tbody>";
						$baca = mysqli_query($conn,"SELECT  *,DATE_FORMAT(tgl_transaksi, '%d/%m/%Y') AS tgl,IF(pembayaran=1,'Tunai','Non Tunai') as bayar,
											         (select nm_pengguna from admin where id=tbl_retur_penjualan.user) as kasir,IF(nm_member<>'',nm_member,'Umum') as pelanggan 
											         FROM tbl_retur_penjualan WHERE tgl_transaksi BETWEEN '$tglx' and '$tgly' ORDER BY no_transaksi,tgl_transaksi");
						$no = 1;	
						while($fetchArray = mysqli_fetch_array($baca)){
								...
								echo "<tr>
										...
										<td class=\"text-center\" style=\"font-size:12px;\">$fetchArray[faktur]</td>
										<td class=\"text-left\" style=\"font-size:12px;\">$fetchArray[pelanggan]</td>
						...
						echo "</tbody>
									<tr>
										<td class=\"text-right\" style=\"font-size:12px;\" colspan=6><b>Jumlah Total</b></td>
				  ...
				  <?php
					 echo "<div class=\"table-responsive\">
									...
									<tr>
										...
										<td>
											<form method=\"post\" action=\"welcome.php?modul=returpenjualan&aksi=view\">
