	  ...
	  $baca = mysql_query("SELECT x.* FROM (
			...
			if($fetchArray['cek']=='1'){
				...
				$x4 = mysql_query("SELECT IFNULL(SUM(a.nilai),0) AS nilai FROM trdtransout_fktp a 
				                  where left(kd_kegiatan,16)='".substr($fetchArray['kode'],0,16)."' and month(tgl_bukti) IN ('10','11')");
			...
			if($fetchArray['cek']=='2'){
				...
				$x4 = mysql_query("SELECT IFNULL(SUM(a.nilai),0) AS nilai FROM trdtransout_fktp a 
				                  where left(kd_kegiatan,20)='".substr($fetchArray['kode'],0,20)."' and month(tgl_bukti) IN ('10','11')");
			    $x14 = mysql_fetch_array($x4);
			...
			if($fetchArray['cek']=='3'){
				...
				$x4 = mysql_query("SELECT IFNULL(SUM(a.nilai),0) AS nilai FROM trdtransout_fktp a 
				                  where left(kd_kegiatan,27)='".substr($fetchArray['kode'],0,27)."' and month(tgl_bukti) IN ('10','11')");
			    $x14 = mysql_fetch_array($x4);
				...
				$x4 = mysql_query("SELECT IFNULL(SUM(a.nilai),0) AS nilai FROM trdtransout_fktp a 
				                  where left(kd_kegiatan,27)='".substr($fetchArray['kode'],0,27)."' and kd_rek5 LIKE '%$fetchArray[kodok]%'  and month(tgl_bukti) IN ('10','11')");
			    $x14 = mysql_fetch_array($x4);
