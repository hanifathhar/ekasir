...
echo "<table width=100% cellpadding=3 cellspacing=0 border=1 style=\"border-collapse:0px; font-size:9px;\" align=\"center\">
					 ...
					 <TR>
						...
						<TD width=\"40%\" align=\"center\" style=\"font-size:12px;\" colspan=4><b>Realisasi Belanja (Rp)</b></TD>
	  ...
	  $baca = mysql_query("SELECT x.* FROM (
			...
			if($fetchArray['cek']=='1'){
				...
				$x2 = mysql_query("SELECT IFNULL(SUM(a.nilai),0) AS nilai FROM trdtransout_fktp a 
				                  where left(kd_kegiatan,16)='".substr($fetchArray['kode'],0,16)."' and month(tgl_bukti) IN ('5','6')");
			    $x12 = mysql_fetch_array($x2);
				
				$x3 = mysql_query("SELECT IFNULL(SUM(a.nilai),0) AS nilai FROM trdtransout_fktp a 
				                  where left(kd_kegiatan,16)='".substr($fetchArray['kode'],0,16)."' and month(tgl_bukti) IN ('')");
	 		  ...
	 		  echo "<TR>
						...
						<TD width=\"10%\" align=\"right\" style=\"font-size:12px;\"><b>".number_format($x14['nilai'],2,",",".")."</b></TD>	
						<TD width=\"10%\" align=\"right\" style=\"font-size:12px;\"><b>".number_format($x11['nilai']+$x12['nilai']+$x13['nilai']+$x14['nilai'],2,",",".")."</b></TD>	
						<TD width=\"10%\" align=\"right\" style=\"font-size:12px;\"><b>".number_format($fetchArray['nilai']-($x11['nilai']+$x12['nilai']+$x13['nilai']+$x14['nilai']),2,",",".")."</b></TD>			
					 </TR>";
			}else
			if($fetchArray['cek']=='2'){
				...
				$x2 = mysql_query("SELECT IFNULL(SUM(a.nilai),0) AS nilai FROM trdtransout_fktp a 
				                  where left(kd_kegiatan,20)='".substr($fetchArray['kode'],0,20)."' and month(tgl_bukti) IN ('5','6')");
			    $x12 = mysql_fetch_array($x2);
				
				$x3 = mysql_query("SELECT IFNULL(SUM(a.nilai),0) AS nilai FROM trdtransout_fktp a 
				                  where left(kd_kegiatan,20)='".substr($fetchArray['kode'],0,20)."' and month(tgl_bukti) IN ('')");
			    $x13 = mysql_fetch_array($x3);
			...
			if($fetchArray['cek']=='3'){
				...
				$x2 = mysql_query("SELECT IFNULL(SUM(a.nilai),0) AS nilai FROM trdtransout_fktp a 
				                  where left(kd_kegiatan,27)='".substr($fetchArray['kode'],0,27)."' and month(tgl_bukti) IN ('5','6')");
			    $x12 = mysql_fetch_array($x2);
				
				$x3 = mysql_query("SELECT IFNULL(SUM(a.nilai),0) AS nilai FROM trdtransout_fktp a 
				                  where left(kd_kegiatan,27)='".substr($fetchArray['kode'],0,27)."' and month(tgl_bukti) IN ('')");
			    $x13 = mysql_fetch_array($x3);
				...
				$x2 = mysql_query("SELECT IFNULL(SUM(a.nilai),0) AS nilai FROM trdtransout_fktp a 
				                  where left(kd_kegiatan,27)='".substr($fetchArray['kode'],0,27)."' and kd_rek5 LIKE '%$fetchArray[kodok]%'  and month(tgl_bukti) IN ('5','6')");
			    $x12 = mysql_fetch_array($x2);
				
				$x3 = mysql_query("SELECT IFNULL(SUM(a.nilai),0) AS nilai FROM trdtransout_fktp a 
				                  where left(kd_kegiatan,27)='".substr($fetchArray['kode'],0,27)."' and kd_rek5 LIKE '%$fetchArray[kodok]%'  and month(tgl_bukti) IN ('')");
			    $x13 = mysql_fetch_array($x3);
				...
				echo "<TR>
						...
						<TD width=\"10%\" align=\"right\" style=\"font-size:12px;\">".number_format($x14['nilai'],2,",",".")."</TD>	
						<TD width=\"10%\" align=\"right\" style=\"font-size:12px;\">".number_format($x11['nilai']+$x12['nilai']+$x13['nilai']+$x14['nilai'],2,",",".")."</TD>	
						<TD width=\"10%\" align=\"right\" style=\"font-size:12px;\">".number_format($fetchArray['nilai']-($x11['nilai']+$x12['nilai']+$x13['nilai']+$x14['nilai']),2,",",".")."</TD>			
					 </TR>";
	 ...
	 $no ++;}
		...
		echo "<TR>
						...
						<TD width=\"10%\" align=\"right\" style=\"font-size:12px;\"><h3><b>".number_format($tw4,2,",",".")."</b></h3></TD>	
						<TD width=\"10%\" align=\"right\" style=\"font-size:12px;\"><h3><b>".number_format($tw1+$tw2+$tw3+$tw4,2,",",".")."</b></h3></TD>	
						<TD width=\"10%\" align=\"right\" style=\"font-size:12px;\"><h3><b>".number_format($angg-($tw1+$tw2+$tw3+$tw4),2,",",".")."</b></h3></TD>			
					 </TR>";
