...
$ttd = mysql_query("SELECT  * FROM ms_ttd WHERE kd_skpd='1.01.01.01.00' and kode='KP'");
...
$dpa = mysql_query("SELECT SUM(nilai) AS nilai,  SUM(nilai_ubah) AS nilai_ubah 
					FROM trdrka WHERE kd_skpd='$skpd' AND kd_kegiatan='$giat' AND kd_rek5='$rek'");
...
echo "<table width=100% cellpadding=0 cellspacing=0 border=0 style=\"border-collapse:0px; font-size:9px;\">
	  <tr>
		...
		<td align=center  style=\"font-size:16px;width:10%;\" ><b>PEMERINTAH KABUPATEN TAPANULI SELATAN<br>REKAPITULASI REALISASI BELANJA SEKOLAH BERDASARKAN SP2B</b></td>
		<td align=center  style=\"font-size:12px;width:10%;\" rowspan=2></td>
	  </tr>
	  <tr>
...
echo "<table width=100% cellpadding=3 cellspacing=0 border=1 style=\"border-collapse:0px; font-size:9px;\" align=\"center\">
					 ...
					 <TR>
						...
						<TD width=\"50%\" align=\"center\" style=\"font-size:12px;\" colspan=4><b>Realisasi Belanja<br>(Rp)</b></TD>
			...
			$tw3 = $tw3+$x33[nilai];
				...
				echo "<TR>
						<TD width=\"10%\" align=\"center\" style=\"font-size:12px;\">$fetchArray[kd_skpd]</TD>
							...
							<TD width=\"10%\" align=\"right\" style=\"font-size:12px;\">".number_format($x11[nilai]+$x22[nilai]+$x33[nilai],2,",",".")."</TD>
							<TD width=\"10%\" align=\"right\" style=\"font-size:12px;\">".number_format($b[nilai]-($x11[nilai]+$x22[nilai]+$x33[nilai]),2,",",".")."</TD>			
					 </TR>";
	 ...
	 $no ++;}
			 ...
			 echo "<TR>
							...
							<TD width=\"10%\" align=\"right\" style=\"font-size:12px;\"><b>".number_format($tw1+$tw2+$tw3,2,",",".")."</b></TD>
							<TD width=\"10%\" align=\"right\" style=\"font-size:12px;\"><b>".number_format($angg-($tw1+$tw2+$tw3),2,",",".")."</b></TD>			
					 </TR>";
